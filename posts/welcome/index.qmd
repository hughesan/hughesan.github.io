---
title: "Deciding on a training plan for the 2025 Boston Marathon"
author: "Alex Hughes"
date: "2024-12-17"
...
In adding easy miles to Pfitz 18/55, my peak mileage reached 65 mpw and I had 3-4 weeks around 58-62 mpw. The next step up in the Pfitz plan series are the 70 mpw peak plans (18/70 and 12/70). For Boston, I plan to follow the 18/70 plan, with modifications:
  ...
  + I scaled the total weekly miles down just a bit by multiplying each week by a factor of 67.5/70. So, I'll actually peak at 67.5 mpw, and several weeks will be in the 63-66 mpw range. As for what to drop miles from to achieve this, I'll reference the 18/55 plan and make sure I don't reduce any workouts that are conserved between the plans (e.g., the LT/threshold workouts are identical between the plans, with the 18/70 LT workouts including 1 additional non-LT easy mile). I'm likely to drop a mile from a mid-week 15 miler, or a mile or two from a recovery run.
